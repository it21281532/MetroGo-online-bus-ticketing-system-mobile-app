      ...
      <View style={styles.bottomview}>
        ...
        >
          ...
          <View style={{ flexDirection: "row", marginTop: 10 }}>
            <View>
              ...
              >
                ...
                <Ionicons
                  ...
                  color="#000"
                />
                <Text style={{ marginLeft: 5, fontWeight: "bold" }}>12:00</Text>
              </View>
            ...
            <View>
              <Image source={valid} style={{ width: 110, height: 110 }}></Image>
            </View>
          </View>
        </CustomCard>
        <Text
        ...
        <View>
          ...
          >
            ...
            <Text style={{ fontWeight: "bold" }}>Balance : Rs.600</Text>
          </View>
          <View
            style={{
              flexDirection: "row",
          ...
          >
            ...
            <Text style={{ fontWeight: "bold" }}>Balance : Rs.840</Text>
          </View>
        </View>
        <TouchableOpacity
          style={{
